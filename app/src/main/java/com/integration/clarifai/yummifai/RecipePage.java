...
public class RecipePage extends AppCompatActivity {
    ...
    private void setUpGoogleCalender(){
        mProgress = new ProgressDialog(this);
        mProgress.setMessage("Adding the recipe link to Google Calendar ...");
    ...
    public void showDialog(){
        ...
        FireEventDialogFragment newFragment = new FireEventDialogFragment();
